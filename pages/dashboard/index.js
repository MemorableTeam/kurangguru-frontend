...
const UserDashboard = () => {
  ...
  const startOfWeek = moment(value ? value : setValue(today1)).startOf(
    "isoWeek"
  );
  ...
  return (
    <>
      ...
      <div
        className="container-fluid bg-blue-light sm-bg h-dashboard"
        style={{ height: "100vh" }}
      >
              ...
              >
                <Row className="h-100">
                  <Col xs={12} style={{ height: "40%" }}>
                    <h5
                      className="py-3 bg-white px-3 mb-0 fw-500"
                      style={{
                        borderTopLeftRadius: "30px",
                        borderTopRightRadius: "30px",
                      }}
                  ...
                  >
                    <h5
                      className="py-3 bg-white px-4 mb-0 fw-500"
                      style={{
                        borderTopLeftRadius: "30px",
                        borderTopRightRadius: "30px",
                      }}
                      ...
                      <Button
                        className={`${
                          pickDay == date[0]
                            ? "btn-blue-dark"
                            : "bg-white text-black"
                        } b-hover border-radius-10 shadow-none border-0 me-4`}
                        onClick={(e) => setValue(fullDate[0])}
                      >
                      ...
                      <Button
                        className={`${
                          pickDay == date[6]
                            ? "btn-blue-dark"
                            : "bg-white text-black"
                        } b-hover border-radius-10 shadow-none border-0 me-3`}
                        onClick={(e) => setValue(fullDate[6])}
                      >
                    ...
                    <div className="d-flex justify-content-center bg-white d-tab">
                      <div
                        className={`mx-3 py-1 tab ${
                          activeTabs === 1 ? "text-blue-dark" : "text-grey-dark"
                        }`}
                      ...
                      <div
                        className={`mx-3 py-1 tab ${
                          activeTabs === 2 ? "text-blue-dark" : "text-grey-dark"
                        }`}
                    ...
                    <div
                      className={`py-2 tab ${
                        activeTabs === 1 ? "d-block bg-white" : "d-none"
                      }`}
                    >
                      <Row className="mx-3 px-2 py-2 t-schedule">
                        ...
                        <Col xs={9} className="mb-1">
                          <Row className="t-schedule" className="mb-1">
                            <Col xs={9} className="bg-grey">
                              Test1
                            </Col>
                            <Col xs={3} className="bg-blue-dark">
                              Test2
                            </Col>
                          </Row>
                          <Row className="t-schedule" className="mb-1">
                    ...
                    <div
                      className={`py-2 tab ${
                        activeTabs === 2 ? "bg-white d-block" : "d-none"
                      }`}
                    >
                      <Row className="mx-3 px-2 py-2 t-schedule">
                        <Col xs={3} className="text-center align-self-center">
