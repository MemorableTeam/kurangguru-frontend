            ...
            <form onSubmit={handleSubmit(processLogin)}>
              <div className="mb-3">
                ...
                <input
                  ...
                  type="text"
                  className={`username form-control shadow-none border-radius-10 py-3 bg-transparent ${
              ...
              <div className="mb-1">
                ...
                <div className="input-group">
                  <input
                    ...
                    type="password"
                    className={`password form-control shadow-none border-radius-10 py-3 r-none bg-transparent ${
        ...
        <div className="border-radius-10">
          <Modal.Body className="py-3 px-3">
            ...
            <div className="d-flex flex-row bd-highlight mb-3">
              ...
              <h3 className="mx-auto w-100 text-danger text-center align-self-center">
                {message}
              </h3>
            </div>
            <Button onClick={() => setShow(false)} className="float-end my-3">
              Close
            </Button>
          </Modal.Body>
        </div>
